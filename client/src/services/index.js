...
export const customReportExportUrl = (params, format = "csv") => {
  const query = new URLSearchParams({ ...params, export: format }).toString();
  return `${client.defaults.baseURL}/reports/custom?${query}`;
};
export const customReportCsvUrl = (params) => customReportExportUrl(params, "csv");
export const customReportXlsxUrl = (params) => customReportExportUrl(params, "xlsx");
export const customReportPdfUrl = (params) => customReportExportUrl(params, "pdf");
